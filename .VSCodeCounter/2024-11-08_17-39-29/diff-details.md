...
| [code/kernel/config/fs_img.h](/code/kernel/config/fs_img.h) | C | -42 | -9 | -14 | -65 |
...
| [code/kernel/config/sysdef.h](/code/kernel/config/sysdef.h) | C++ | -75 | -8 | -7 | -90 |
...
| [code/kernel/fs/file.c](/code/kernel/fs/file.c) | C | -281 | -3 | -21 | -305 |
| [code/kernel/fs/file.h](/code/kernel/fs/file.h) | C | -45 | -1 | -6 | -52 |
...
| [code/kernel/fs/sfs/sfs.c](/code/kernel/fs/sfs/sfs.c) | C | 5 | -1 | 1 | 5 |
| [code/kernel/fs/sfs/sfs_inode.c](/code/kernel/fs/sfs/sfs_inode.c) | C | 3 | 3 | 0 | 6 |
...
| [code/kernel/kernel/proc.c](/code/kernel/kernel/proc.c) | C | -1,017 | -154 | -91 | -1,262 |
...
| [code/kernel/kernel/syscall.c](/code/kernel/kernel/syscall.c) | C | -166 | -5 | -11 | -182 |
| [code/kernel/kernel/syscall.h](/code/kernel/kernel/syscall.h) | C++ | -13 | -1 | -4 | -18 |
| [code/kernel/kernel/sysfile.c](/code/kernel/kernel/sysfile.c) | C | -406 | -11 | -50 | -467 |
...
| [code/user/libs/user.c](/code/user/libs/user.c) | C | -230 | -1 | -60 | -291 |
| [code/user/libs/user.h](/code/user/libs/user.h) | C | -61 | 0 | -1 | -62 |
| [code/user/libs/usys.S](/code/user/libs/usys.S) | Assembler file | -268 | 0 | -1 | -269 |
| [code/user/libs/usys.py](/code/user/libs/usys.py) | Python | -23 | -2 | -6 | -31 |
| [code/user/output/user.asm](/code/user/output/user.asm) | Assembler file | -16,411 | 0 | -585 | -16,996 |
| [code/user/test/usertests.c](/code/user/test/usertests.c) | C | -1,509 | -75 | -161 | -1,745 |
